<%@ page language="C#" autoeventwireup="true" codebehind="Home.aspx.cs" inherits="MisOfertasMio.Home" %>
...
<body onload="esconde();">
    ...
    <form id="form1" runat="server">
        <div>
            <center>
                <br />
            <font color="black"><h1 >OFERTAS PUBLICADAS PARA USTED</h1></font>
                <hr style="width:80%; height: 3px; background: #0066CC; color:#0066CC; opacity:0.8;"/>
            <div class="row" style="text-align:center; max-width:87%;">
                <% 
                ...
                <div class="card text-dark bg-primery mb-3" style="max-width: 18rem; opacity: 0.95; width: 300px; height:450px;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <br />
                            <asp:Label ID="lblOferta" runat="server" Text="PRECIO OFERTA" ForeColor="Green"></asp:Label><br />
